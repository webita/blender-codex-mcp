# Blender Codex MCP fork by Webita - Giorgio Sanna.
...
bl_info = {
    "name": "Blender Codex MCP",
    "author": "Blender Codex MCP",
    "version": (1, 2),
    "blender": (3, 0, 0),
    "location": "View3D > Sidebar > BlenderCodexMCP",
    "description": "Connect Blender to Codex via MCP",
    "category": "Interface",
}
...
class BlenderMCPServer:
    ...
    def start(self):
        ...
        try:
            ...
            print(f"Blender Codex MCP server started on {self.host}:{self.port}")
    ...
    def stop(self):
        ...
        print("Blender Codex MCP server stopped")
        ...
        if enabled:
            ...
            return {
                ...
                "message": """PolyHaven integration is currently disabled. To enable it:
                            1. In the 3D Viewport, find the BlenderCodexMCP panel in the sidebar (press N if hidden)
                            2. Check the 'Use assets from Poly Haven' checkbox
                            3. Restart the connection to Codex"""
        }
            ...
            if not bpy.context.scene.blendermcp_hyper3d_api_key:
                return {
                    ...
                    "message": """Hyper3D Rodin integration is currently enabled, but API key is not given. To enable it:
                                ...
                                4. Restart the connection to Codex"""
                }
...
class BLENDERMCP_AddonPreferences(bpy.types.AddonPreferences):
    ...
    telemetry_consent: BoolProperty(
        ...
        description="Allow collection of prompts, code snippets, and screenshots to help improve Blender Codex MCP",
        default=True
    )
...
class BLENDERMCP_PT_Panel(bpy.types.Panel):
    bl_label = "Blender Codex MCP"
    bl_idname = "BLENDERMCP_PT_Panel"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = 'BlenderCodexMCP'
...
class BLENDERMCP_OT_StartServer(bpy.types.Operator):
    ...
    bl_label = "Connect to Codex"
    bl_description = "Start the Blender Codex MCP socket server"
...
class BLENDERMCP_OT_StopServer(bpy.types.Operator):
    ...
    bl_label = "Stop the connection to Codex"
    bl_description = "Stop the Blender Codex MCP socket server"
...
def register():
    bpy.types.Scene.blendermcp_port = IntProperty(
        name="Port",
        description="Port for the Blender Codex MCP server",
        default=9876,
        min=1024,
        max=65535
    )
    ...
    print("Blender Codex MCP addon registered")
...
def unregister():
    ...
    print("Blender Codex MCP addon unregistered")
